...
CREATE TABLE "jobs" (
 ...
 is_active INTEGER NOT NULL DEFAULT 1 CHECK(is_active IN (0,1)), classification TEXT, excluded INTEGER NOT NULL DEFAULT 0 CHECK(excluded IN (0,1)), exclusion_reason TEXT, score_details TEXT, scored_at TEXT);