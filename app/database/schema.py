STATUSES = ('Nueva', 'Pendiente de revisar', 'Me interesa', 'CV enviado', 'Inscrito', 'Descartada')
SCHEMA = """
CREATE TABLE IF NOT EXISTS companies (
 ...
 accepts_spontaneous_application INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS jobs (
 id INTEGER PRIMARY KEY, external_id TEXT NOT NULL, title TEXT NOT NULL,
 ...
 category TEXT, employment_type TEXT, professional_profile TEXT, service_line TEXT, study_area TEXT,
 general_application INTEGER NOT NULL DEFAULT 0);
